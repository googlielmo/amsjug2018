...
import demo.btcdx2018.Constants;
import demo.btcdx2018.CurrencyPairKey;
import demo.btcdx2018.CurrencyPairValue;
import demo.btcdx2018.TimePrice;
...
public class MovingAverageDAG {
	...
	public static DAG build(String bootstrapServers) {
        ...
        // Key as JSON
        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class.getCanonicalName());
        properties.setProperty(JsonDeserializer.KEY_DEFAULT_TYPE, CurrencyPairKey.class.getName());
        // Value as JSON
        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class.getCanonicalName());
        properties.setProperty(JsonDeserializer.VALUE_DEFAULT_TYPE, CurrencyPairValue.class.getName());
        
        DAG dag = new DAG();
        
        // Use a built-in processor to read from Kafka
        Vertex kafka = dag.newVertex("Kafka Source",
                KafkaProcessors.streamKafkaP(properties, WatermarkGenerationParams.noWatermarks(), Constants.TOPIC_CURRENCY_NAME))
                ;
        ...
        Vertex priceSink = dag.newVertex("BTC/USD IMap Sink",
        		SinkProcessors.writeMapP(Constants.IMAP_NAME_BTC_USD)
        		);
        ...
        myAggregation = AggregateOperation
        	     ...
        	     .andFinish(TimePriceGrouper::get)
        	     ;
        ...
        Vertex alertMapSink = dag.newVertex("Alert IMap Sink",
        		SinkProcessors.writeMapP(Constants.IMAP_NAME_ALERT)
        		);
