...
public class MovingAverageProcessor extends AbstractProcessor {
	...
	protected boolean tryProcess(int ordinal, Object item) {
		 ...
		 * would be to do this in the sender not this class.
		 */
		Map.Entry<CurrencyPairKey, CurrencyPairValue> entry =
				(Map.Entry<CurrencyPairKey, CurrencyPairValue>) item;
		...
		this.rates[position] = entry.getValue().getRate();
		this.day = entry.getValue().getDay();
